...
public void testCompare() throws InterruptedException, IOException{
//#1
...
//
//		
//	//	List <WebElement> first = driver.findElements(By
//		//		.cssSelector(".branded-page-v2-subnav-container branded-page-gutter-padding"));
//		
//
//WebElement  first = driver.findElement(By
//						.cssSelector("#section-list-446815 > li.branded-page-v2-subnav-container.branded-page-gutter-padding > div > div.filter-top > div > div.filter-crumb-spacer"));
//				
//    first.click();		
